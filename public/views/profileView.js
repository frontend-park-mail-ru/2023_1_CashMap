...
export default class ProfileView extends BaseView {
	...
	_preRender() {
		...
		header['avatar_url'] = userStore.userProfile.avatar_url;
		this._context = {
			sideBarData: sideBarConst,
			headerData: header,
			profileData: userStore.userProfile,
			postAreaData: {createPostData: {avatar: userStore.userProfile.avatar_url, jsId: 'js-create-post'}, postList: postsStore.posts},
