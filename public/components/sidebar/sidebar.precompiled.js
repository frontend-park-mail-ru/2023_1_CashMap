(function () {
  ...
  templates.sidebar = template({
    1: function (container, depth0, helpers, partials, data) {
      ...
      return '        \n            <a href=' +
    alias4(((helper = (helper = lookupProperty(helpers, 'ref') || (depth0 != null ? lookupProperty(depth0, 'ref') : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'ref', hash: {}, data, loc: { start: { line: 10, column: 20 }, end: { line: 10, column: 29 } } }) : helper))) +
    '>\n                <li class="nav-item">\n                    <img class="nav-item-icon" src=' +
    alias4(((helper = (helper = lookupProperty(helpers, 'iconPath') || (depth0 != null ? lookupProperty(depth0, 'iconPath') : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'iconPath', hash: {}, data, loc: { start: { line: 12, column: 51 }, end: { line: 12, column: 65 } } }) : helper))) +
    '>\n                    <img class="nav-item-icon" src=' +
    alias4(((helper = (helper = lookupProperty(helpers, 'hoveredIconPath') || (depth0 != null ? lookupProperty(depth0, 'hoveredIconPath') : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'hoveredIconPath', hash: {}, data, loc: { start: { line: 13, column: 51 }, end: { line: 13, column: 72 } } }) : helper))) +
    '>\n                    <div class="nav-item-text"><span>' +
    alias4(((helper = (helper = lookupProperty(helpers, 'title') || (depth0 != null ? lookupProperty(depth0, 'title') : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'title', hash: {}, data, loc: { start: { line: 14, column: 53 }, end: { line: 14, column: 64 } } }) : helper))) +
    '</span></div>\n' +
    ((stack1 = lookupProperty(helpers, 'if').call(alias1, (depth0 != null ? lookupProperty(depth0, 'notifies') : depth0), { name: 'if', hash: {}, fn: container.program(2, data, 0), inverse: container.noop, data, loc: { start: { line: 15, column: 20 }, end: { line: 17, column: 27 } } })) != null ? stack1 : '') +
    '                </li>\n            </a>\n\n'
    },
