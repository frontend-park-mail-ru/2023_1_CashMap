...
templates['signup'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<main-reg class=\"main-reg\">\n    <div class=\"logo-path\" style=\"background-image: url("
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"picPath") || (depth0 != null ? lookupProperty(depth0,"picPath") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"picPath","hash":{},"data":data,"loc":{"start":{"line":4,"column":69},"end":{"line":4,"column":82}}}) : helper)))
