(function () {
  ...
  templates.login = template({
    ...
    alias4(((helper = (helper = lookupProperty(helpers, 'fonPath') || (depth0 != null ? lookupProperty(depth0, 'fonPath') : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'fonPath', hash: {}, data, loc: { start: { line: 26, column: 56 }, end: { line: 26, column: 69 } } }) : helper))) +
    ')">\n        <div class="logo-table">\n            <div class="logo-pic" style="background-image: url(' +
    alias4(((helper = (helper = lookupProperty(helpers, 'picPath') || (depth0 != null ? lookupProperty(depth0, 'picPath') : depth0)) != null ? helper : alias2), (typeof helper === alias3 ? helper.call(alias1, { name: 'picPath', hash: {}, data, loc: { start: { line: 28, column: 63 }, end: { line: 28, column: 76 } } }) : helper))) +
