...
Router.registerPage('/sign-in', Views.SignInView);
Router.registerPage('/sign-up', Views.SignUpView);
...
Router.registerPage('/find-friends', Views.FriendsView);
Router.registerPage('/group', Views.GroupView);
Router.registerPage('/groups', Views.GroupsView);
Router.registerPage('/manage-groups', Views.GroupsView);
Router.registerPage('/find-groups', Views.GroupsView);
Router.registerPage('/popular-groups', Views.GroupsView);
Router.registerPage('/my-page', Views.ProfileView);
Router.registerPage('/user', Views.ProfileView);
Router.registerPage('/settings-group', Views.SettingsGroupView);
